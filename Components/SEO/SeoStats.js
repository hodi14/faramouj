        ...
        <div className="items">
          <div className="item">
            <div className="picture animation pop">
                <Image loading="eager" src={folder} alt="شروع وبگردی با جست و جو" layout="fill" />
            </div>
            <div className="text">
                <h6>
                شروع وبگردی
          ...
          <div className="item">
            <div className="picture animation pop">
                <Image loading="eager" src={shield} alt="فقط دیدن صفحه 1 نتایج" layout="fill"  />
            </div>
            <div className="text">
                <h6>
                     فقط دیدن
          ...
          <div className="item">
            <div className="picture animation pop">
                <Image loading="eager" src={star} alt="کلیک برروی نتایج اول" layout="fill"  />
            </div>
            <div className="text">
                <h6>
                    کلیک برروی
          ...
          <div className="item">
            <div className="picture animation pop">
                <Image loading="eager" src={user} alt="عدم اعتماد به تبلیغ گوگل" layout="fill" />
            </div>
            <div className="text">
                <h6>
                    عدم اعتماد به
